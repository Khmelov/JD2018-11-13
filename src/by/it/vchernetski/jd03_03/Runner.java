...
//        MyDAO daoGarage = MyDAO.getDao(garage);
...
//        Role role = new Role();
//        role.setRole("rrrrrr");
//        MyDAO daoRole = MyDAO.getDao(role);
...
//        user.setRoles_id(1);
//        MyDAO daoUser = MyDAO.getDao(user);
