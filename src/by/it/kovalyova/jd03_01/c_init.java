...
public class c_init {
    ...
    try {
        ...
        try (
    Connection connection=DriverManager.getConnection("jdbc:mysql://127.0.0.1:206/", "root",""))
    {
        ...
        statement.executeUpdate("CREATE TABLE IF NOT EXIST 'kovalyova'.'roles' (\n"+
        ...
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS 'kovalyova'.'users' (\n" +
                ...
                "    ON UPDATE RESTRICT)\n" +
                "ENGINE = InnoDB;\n");
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS `kovalyova`.`ads` (\n" +
                "  `id` INT NOT NULL AUTO_INCREMENT,\n" +
        ...
        statement.executeUpdate("INSERT INTO `kovalyova`.`ads` (`id`, `description`, `address`, `floor`, `floors`, `rooms`, `area`, `price`, `users_id`) VALUES (DEFAULT, 'test1', 'test1 address', 3, 5, 3, 66, 99999, 2);");
        statement.executeUpdate("INSERT INTO `kovalyova`.`ads` (`id`, `description`, `address`, `floor`, `floors`, `rooms`, `area`, `price`, `users_id`) VALUES (DEFAULT, 'test2 description', 'test2 addres', 1, 1, 1, 10, 10000, 2);");
