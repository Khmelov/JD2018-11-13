...
class CommandLogout implements by.it._examples_.jd03_04.java.sample_controller.ActionCommand {
    @Override
    public String execute(HttpServletRequest request) {
        return by.it._examples_.jd03_04.java.sample_controller.Actions.LOGOUT.jsp;
    }
}
