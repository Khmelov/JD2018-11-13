...
public class C_Init {
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:2016/", "root", "")) {
            ...
            statement.executeUpdate("INSERT INTO `kruglenja`.`order` (`id`, `quanity`, `deliveryTime`, `totalPrice`, `users_id`) VALUES (DEFAULT, 12, 15, 1024, 2);");
            statement.executeUpdate("INSERT INTO `kruglenja`.`order` (`id`, `quanity`, `deliveryTime`, `totalPrice`, `users_id`) VALUES (DEFAULT, 12, 44, 444, 1);");
            statement.executeUpdate("INSERT INTO `kruglenja`.`sparePart` (`id`, `model`, `category`, `name`, `serial_number`, `weigth`, `price`) VALUES (DEFAULT, 'Mazda', 'engine', 'engine', 051871051184, '12', 1024);");
            statement.executeUpdate("INSERT INTO `kruglenja`.`sparePart` (`id`, `model`, `category`, `name`, `serial_number`, `weigth`, `price`) VALUES (DEFAULT, 'Ford', 'motor', 'motor', 214045204524, '352', 41233);");
