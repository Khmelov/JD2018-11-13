...
public class C_Init {
    ...
    static void createDatabase(Config config) {
        ...
        System.out.println(config.getDatabaseURL()+" " + config.getNameDatabase()+ " " + config.getPassword());
    ...
    private static void addRole(String roleName) throws SQLException{
        statement.executeUpdate(
                "INSERT INTO `"+config.getNameDatabase()+"`.`roles` (`id_role`, `role`) " +
    ...
    private  static void addAnswer(String answer, String status, long idQuestion) throws SQLException {
        statement.executeUpdate("INSERT INTO `"+config.getNameDatabase()+"`.`answers` (`id_answer`, `answer`, `status`, `id_question`)" +
    ...
    private static void addLesson(String theory, long idTest, long idTheme, long idType) throws SQLException{
        statement.executeUpdate("INSERT INTO `"+config.getNameDatabase()+"`.`lessons` (`id_lesson`, `theory`, `id_test`, `id_theme`, `id_type`)" +
