...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="description" name="description" value="Описание description description" type="text" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="address" name="address" type="text" value="Ленина 59" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="rooms" name="rooms" class="form-control" multiple="multiple">
      ...
      <option value="3" selected>3-room</option>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="area" name="area" type="text" value="55.5" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="price" name="price" value="66666.6" type="text" placeholder="" class="form-control input-md" required="">
