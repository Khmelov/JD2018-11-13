package by.it.skarpovich.project.java.dao;//package by.it.skarpovich.jd03_03.dao;
//
...
//
//public class UniversalDAO_helptool<TypeBean> implements InterfaceDao<TypeBean> {
//
...
//
//    //конструктор DAO
//    public UniversalDAO_helptool(TypeBean bean, String sqlTableName) {
//        this.bean = bean;
