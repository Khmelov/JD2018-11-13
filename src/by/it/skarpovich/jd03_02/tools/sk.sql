...
START TRANSACTION;
USE `skarpovich`;
INSERT INTO `skarpovich`.`orders` (`id`, `date`, `time`, `users_id`, `items_id`) VALUES (DEFAULT, '2019-01-19', '10:59:59', 2, 1);
INSERT INTO `skarpovich`.`orders` (`id`, `date`, `time`, `users_id`, `items_id`) VALUES (DEFAULT, '2019-01-20', '11:00:00', 2, 2);
