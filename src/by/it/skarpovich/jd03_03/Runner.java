package by.it.skarpovich.jd03_03;

import by.it.skarpovich.jd03_03.beans.*;
import by.it.skarpovich.jd03_03.dao.Dao;
...
public class Runner {
    public static void main(String[] args) throws SQLException {
        ...
        ///ITEMS test
        Item item = new Item(5, "Z300", 2, 300, "concrete blocks", 670);
        if (dao.item.create(item))
            System.out.println("CREATED: " + item);
        item.setTitle("Zx777");
        item.setMaterials("wood");
