...
public class TaskA {
    ...
    public static void generateToXML() {
        try {
            ...
            Ads ads = new Ads();
            Ad ad = new Ad("Nice car", "BMW", "m3", "red", "sedan", 2006, "Comfort", 658, false, 7200);
            User user = new User("Anton Zhivov","Jerome94","A59915991","23.12.1994","jerome@astero.com","+375333830046",ads);
            persons.getUser().add(user);
            ads.getAd().add(ad);
            ad = new Ad("Super 8", "Volvo", "XC90", "red", "sedan", 2006, "Comfort", 658, false, 7200);
            ads.getAd().add(ad);
            ads = new Ads();
            user = new User("Pepper", "guzli", "awdawwa22", "23.12.2016", "dwadaw@dwaWD.ru", "+375333830046", ads);
            ad = new Ad("Batmobile", "VAZ", "2101", "pupule", "sedan", 1985, "Comfort", 580000, true, 23000);
            persons.getUser().add(user);
            ads.getAd().add(ad);
